...
def summary_statistics(table, keyList):
    ...
    stats = [['============',  '=====',  '=====',  '=======',  '======',  '====='],
            ...
            ['============',  '=====',  '=====',  '=======',  '======',  '====='],
            ['mpg', minimum(table,0), maximum(table,0), mid(table,0), round(average(table,0),-1), median(table,0)],
            ['displacement', minimum(table,2), maximum(table,2), mid(table,2), round(average(table,2),-1), median(table,2)],
            ['horsepower', minimum(table,3), maximum(table,3), mid(table,3), round(average(table,3),-1), median(table,3)],
            ['weight', minimum(table,4), maximum(table,4), mid(table,4), round(average(table,4),-1), median(table,4)],
            ['acceleration', minimum(table,5), maximum(table,5), mid(table,5), round(average(table,5),-1), median(table,5)],
            ['MSRP', minimum(table,9), maximum(table,9), mid(table,9), round(average(table,9),-1), median(table,9)],
            ['============',  '=====',  '=====',  '=======',  '======',  '=====']]
